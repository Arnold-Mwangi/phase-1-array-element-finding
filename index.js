...
const users = [
  ...
  // find avidor
  const index = users.findIndex(user => user.firstName === "Avidor");
  console.log(index)

//find red
function isRed(element, index, array){
    return element.favoriteColor === "Red";
}

console.log(users.find(isRed))